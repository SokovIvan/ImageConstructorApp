...
namespace ImageConstructorApp
{
	public partial class MainForm : Form
	{
		...
		private Button themeToggleButton; // Переключатель темы
		...
		{
			this.Text = "Конструктор изображений 1.2.2";
		...
		public void ElementsListBox_DrawItem(object sender, DrawItemEventArgs e)
		{
			...
			Color foreColor = isSelected ? Color.White : (UIStylist.isLightTheme ? Color.FromArgb(50, 50, 50) : UIStylist.primaryColor);
		...
		private void InitializeCustomComponents()
		{
			...
			{
				Text = UIStylist.isLightTheme ? "🌙" : "☀️",
				Size = new Size(40, 40),
				Location = new Point(0, 0),
				FlatStyle = FlatStyle.Flat,
				FlatAppearance = { BorderSize = 0 },
				BackColor = UIStylist.accentColor,
			...
			themeToggleButton.BringToFront();
		...
		{
			UIStylist.ToggleTheme(this);
			themeToggleButton.Text = UIStylist.isLightTheme ? "🌙" : "☀️";
			themeToggleButton.BackColor = UIStylist.accentColor;
			themeToggleButton.BringToFront();
		}
